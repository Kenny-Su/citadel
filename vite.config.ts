...
export default defineConfig({
  ...
  resolve: {
    alias: [
      { find: '@citadel/apps/chat/client', replacement: fileURLToPath(new URL('./packages/apps/chat/client.ts', import.meta.url)) },
      { find: '@citadel/apps/chat/server', replacement: fileURLToPath(new URL('./packages/apps/chat/server.ts', import.meta.url)) },
      { find: '@citadel/apps/chess/client', replacement: fileURLToPath(new URL('./packages/apps/chess/client.ts', import.meta.url)) },
      { find: '@citadel/apps/chess/server', replacement: fileURLToPath(new URL('./packages/apps/chess/server.ts', import.meta.url)) },
      { find: '@citadel/apps/snake/client', replacement: fileURLToPath(new URL('./packages/apps/snake/client.ts', import.meta.url)) },
      { find: '@citadel/apps/snake/server', replacement: fileURLToPath(new URL('./packages/apps/snake/server.ts', import.meta.url)) },
